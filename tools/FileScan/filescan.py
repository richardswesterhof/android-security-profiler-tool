...
class FileScan :
    ...
    def _query_mhr(self, hash) :
        ...
        if self.enable_net_connection != True :
            ...
            try :
                ...
                p = subprocess.Popen("bash -c \"whois -h hash.cymru.com " + hash + "\"", \
    ...
    def _is_mhr_reachable(self) :
		...
		# disable this service (making a lot of automated requests is against the TOS)
        return False
		
        result = self._query_mhr("d2fdaf2c293adb2977c8d3c7aa7152553021f949")
        if result == 0 :
            return False
        else :
            return True
